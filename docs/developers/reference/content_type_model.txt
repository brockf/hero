...
[method]int new_content_type (string $name [, boolean $is_standard = FALSE [, boolean $is_privileged = FALSE [, boolean $is_module = FALSE [, string $template = 'content.thtml' [, string $base_url = '']]]]])[/method]

Create a new content type.

[method]void update_content_type (int $content_type_id , string $name [, boolean $is_standard = FALSE [, boolean $is_privileged = FALSE [, string $template = 'content.thtml' [, string $base_url = '']]]])[/method]

Update an existing content type.

[method]boolean delete_content_type (int $content_type_id)[/method]

Delete a content type.

[method]boolean build_search_index (int $content_type_id)[/method]
...
[method]array get_content_type (int $content_type_id)[/method]

Retrieve an array of a single content type, in the same format as `get_content_types()`.

[method]void get_content_types ( [array $filters = array()])[/method]
