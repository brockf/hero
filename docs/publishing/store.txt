...
By default, most Hero themes will display your products by collections in your store.  However, single products and product lists can be displayed however your designer chooses to do so by [customizing your website's theme](/docs/designers/reference/store).
...
Products can also be customized to have custom fields unique to your business.  For example, you may want to specify "Frame Size" for each painting if you are an art store.  [Click here for more information on how to configure custom fields for products](/docs/configuration/custom_fields).
...
* *Price*
* *Weight* - If you have [configured shipping rates to be based on weight](/docs/configuration/shipping), you will want to specify the weight of our products.
* *Tax rules apply to this product* - If checked, this product will be eligible for tax (providing the visitor meets your [configured tax rules](/docs/configuration/taxes))
...
* *Upon purchase, add the user into a member group* - Add the purchasers of this product to one of your configured [member groups](/docs/configuration/member_groups).
