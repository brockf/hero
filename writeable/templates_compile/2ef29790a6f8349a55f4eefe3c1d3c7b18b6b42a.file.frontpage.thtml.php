<?php /* Smarty version Smarty-3.0.6, created on 2011-03-16 16:26:16
         compiled from "/Volumes/MyData/WebSites/Caribou/trunk/themes/orchard/frontpage.thtml" */ ?>
<?php /*%%SmartyHeaderCode:12033683494d812af8d7ab85-66381415%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2ef29790a6f8349a55f4eefe3c1d3c7b18b6b42a' => 
    array (
      0 => '/Volumes/MyData/WebSites/Caribou/trunk/themes/orchard/frontpage.thtml',
      1 => 1300309857,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '12033683494d812af8d7ab85-66381415',
  'function' => 
  array (
  ),
...
if (!is_callable('smarty_block_collections')) include 'app/modules/store/template_plugins/block.collections.php';
...
">RSS Feed</a>
	...
	<p class="intro">Your site is being powered by the <b>Orchard</b> theme for <b><?php echo smarty_function_setting(array('name'=>"app_name"),$_smarty_tpl);?>
</b>!  It's easy to modify and the simplest
	way to get started building your website.</p>
	
	<h1>Our Products</h1>
	<ul class="frontpage_products">
		<?php $_smarty_tpl->smarty->_tag_stack[] = array('collections', array('var'=>"collection")); $_block_repeat=true; smarty_block_collections(array('var'=>"collection"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

		<li>
			<div class="image">
				<a href="<?php echo $_smarty_tpl->getVariable('collection')->value['url'];?>
"><img src="<?php echo $_smarty_tpl->getVariable('collection')->value['image'];?>
" alt="<?php echo $_smarty_tpl->getVariable('collection')->value['name'];?>
" /></a>
			</div>
...
"><?php echo $_smarty_tpl->getVariable('collection')->value['name'];?>
				...
				<p><?php echo $_smarty_tpl->getVariable('collection')->value['description'];?>
.</p>
			</div>
		</li>
		<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_collections(array('var'=>"collection"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
