<?php /* Smarty version Smarty-3.0.6, created on 2011-04-11 23:23:51
         compiled from "/Volumes/MyData/WebSites/Caribou/trunk/themes/night_jungle/subscriptions.thtml" */ ?>
<?php /*%%SmartyHeaderCode:16583908364da3d3d7321765-23792901%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3518eae72a6961a9347cfc1f6d7f5a9cf047c49b' => 
    array (
      0 => '/Volumes/MyData/WebSites/Caribou/trunk/themes/night_jungle/subscriptions.thtml',
      1 => 1300309859,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '16583908364da3d3d7321765-23792901',
  'function' => 
  array (
  ),
...
if (!is_callable('smarty_modifier_regex_replace')) include '/Volumes/MyData/WebSites/Caribou/trunk/app/libraries/smarty/plugins/modifier.regex_replace.php';
...
" />
<title>
Choose Your Subscription - <?php echo smarty_function_setting(array('name'=>"site_name"),$_smarty_tpl);?>
...
">Click here to access the Members Area</a>.</p>
	...
	<?php if (!$_smarty_tpl->getVariable('plans')->value){?>
...
?>
		<li>
			<b><?php echo $_smarty_tpl->tpl_vars['plan']->value['name'];?>
 - <?php echo $_smarty_tpl->getVariable('setting')->value['currency_symbol'];?>
<?php echo smarty_modifier_regex_replace($_smarty_tpl->tpl_vars['plan']->value['amount'],"/\.00/i",'');?>
</b>
			<p><?php echo $_smarty_tpl->tpl_vars['plan']->value['description'];?>
</p>
			<form method="get" style="margin-top:15px" action="<?php echo $_smarty_tpl->tpl_vars['plan']->value['add_to_cart'];?>
">
