<?php /* Smarty version Smarty-3.0.6, created on 2011-04-11 23:02:12
         compiled from "/Volumes/MyData/WebSites/Caribou/trunk/themes/orchard/account_templates/invoices.thtml" */ ?>
<?php /*%%SmartyHeaderCode:18864886314da3cec4761790-55068441%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9eed753fefa13dda9e0b9510ad6b00b5f16d2f90' => 
    array (
      0 => '/Volumes/MyData/WebSites/Caribou/trunk/themes/orchard/account_templates/invoices.thtml',
      1 => 1300309857,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '18864886314da3cec4761790-55068441',
  'function' => 
  array (
  ),
...
" />
<title>
Invoices - <?php echo smarty_function_setting(array('name'=>"site_name"),$_smarty_tpl);?>
...
">RSS Feed</a>
	...
	<?php if (!$_smarty_tpl->getVariable('for_subscription')->value){?>
	<h1>Invoices</h1>
	<?php }else{ ?>
	<h1>Invoices for Subscription #<?php echo $_smarty_tpl->getVariable('for_subscription')->value;?>
</h1>
	<?php }?>
	<a href="javascript:history.go(-1)">go back</a>
	
	<?php if ($_smarty_tpl->getVariable('invoices')->value){?>
		<ul>
...
?>
			<?php $_smarty_tpl->tpl_vars["invoice_id"] = new Smarty_variable($_smarty_tpl->tpl_vars['invoice']->value['id'], null, null);?>
				<li>
					<a href="<?php echo smarty_function_url(array('path'=>"users/invoice/".($_smarty_tpl->getVariable('invoice_id')->value)),$_smarty_tpl);?>
"><?php echo smarty_function_setting(array('name'=>"currency_symbol"),$_smarty_tpl);?>
<?php echo $_smarty_tpl->tpl_vars['invoice']->value['amount'];?>
 (<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['invoice']->value['date'],"%B %d, %Y");?>
)</a>
				</li>
			<?php }} ?>
		</ul>
