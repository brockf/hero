...
/**
* Member Relationship Fieldtype
*
* @extends Fieldtype
* @class Relationship_fieldtype
*/

class Member_relationship_fieldtype extends Fieldtype {
	/**
	* Constructor
	*
	...
	function output_shared () {
		...
		if (!empty($users)) {
			foreach ($users as $user) {
				$options[] = array('name' => $user['email'] . ' (' . $user['last_name'] . ', ' . $user['first_name'] . ')', 'value' => $user['id']);
			}
		}
