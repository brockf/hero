...
class Admincp extends MY_Controller {
	...
	{	
		...
		$this->dataset->Initialize('charge_model','GetCharges',$columns,site_url('admincp/transactions/index'));
		...
		$this->load->view('transactions/transactions.php', $data);
	}
	...
	{	
		...
		$this->load->view('transactions/recurrings.php');
	}
