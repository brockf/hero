...
<h1><?=$form_title;?></h1>
<form class="form" id="form_user_field" method="post" action="<?=$form_action;?>">
<fieldset>
	<legend>Field Options</legend>
	<ul class="form">
		<?=$this->load->view('cp/field_form.php', array('field' => $field));?>
		<li>
			<label for="billing_equiv" class="full">Should this field be used to auto-populate a billing address field?</label>
		</li>
		<li>
