	...
	*/
	...
	function update ($db_version) {	
		if ($db_version < 1.0) {
			...
			$this->CI->settings_model->new_setting(6, 'search_delay', '15', 'How many seconds should we force the user to wait after a search before they search again?', 'text', '', FALSE, TRUE);
